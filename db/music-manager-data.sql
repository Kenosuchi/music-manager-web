...
insert into `music-manager`.playlist(listener_id, song_id) values (1,1);
insert into `music-manager`.playlist(listener_id, song_id) values (1,3);
insert into `music-manager`.playlist(listener_id, song_id) values (1,5);
insert into `music-manager`.playlist(listener_id, song_id) values (2,1);
insert into `music-manager`.playlist(listener_id, song_id) values (2,4);
